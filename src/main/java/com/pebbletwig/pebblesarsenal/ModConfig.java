...
public class ModConfig {
        ...
        @Config.Comment("THIS CAUSES JEI DISPLAY ERRORS, PLEASE ENABLE BEFORE STARTING A NEW WORLD. Set this to true to disable anything related to anything Thermal may provide ex. Copper & Tin. Note, this will disable this mod's materials and base swords, leaving knives and greatswords. Lastly, it will prevent the items from being registered, so they will disappear if you enable this after creating the swords.")

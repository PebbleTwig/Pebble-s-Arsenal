...
public class ItemKnife extends  net.minecraft.item.ItemAxe{
    //Name of Knife
    private String name;
    ...
    //Like the BattleAxe, override the 2 point damage to 1
    @Override
    ...
    public Multimap<String, AttributeModifier> getAttributeModifiers(EntityEquipmentSlot slot, ItemStack stack) {
        ...
        if (slot == EntityEquipmentSlot.MAINHAND) {
            ...
            replaceModifier(modifiers, SharedMonsterAttributes.ATTACK_SPEED, ATTACK_SPEED_MODIFIER, .665);
        }
        return modifiers;
    }
